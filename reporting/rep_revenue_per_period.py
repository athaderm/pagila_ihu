create or replace table reporting_db.rep_revenue_per_period as
...
from payments
 ...
 , coalesce(payments_per_period.total_revenue,0) as total_revenue
 from reporting_dates
 left join payments_per_period
